 ...
 */
public class UserPropertiesIterator implements Iterator<String> {
     ...
     */
    public UserPropertiesIterator() {

        //open file and read from it...
        BufferedReader br = null;
        try {
            Scanner myReader = new Scanner(new File("phase1/src/user_properties.txt"));
            ...
            System.out.println("user_properties.txt is missing");
            e.printStackTrace();
        }
    }
