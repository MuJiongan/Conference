...
public class UserTest {
    ...
    public void testConstructor(){
        Attendee attendee = new Attendee("a", "a", "123",100);
        Organizer organizer = new Organizer("o", "o", "123", 200);
        Speaker speaker = new Speaker("s", "s", "123", 300);
    }
    ...
    public void testGetName(){
        Attendee attendee = new Attendee("a", "a", "123",100);
        Organizer organizer = new Organizer("o", "o", "123",200);
        Speaker speaker = new Speaker("s", "s", "789",300);
        assertSame("incorrect name\n", "a", attendee.getName());
        assertSame("incorrect name\n", "o", organizer.getName());
        assertSame("incorrect name\n", "s", speaker.getName());
        attendee.userSetName("a1");
        assertSame("incorrect name\n", "a1", attendee.getName());
    }
    ...
    public void testGetUserID(){
        ...
        Organizer organizer = new Organizer("o", "o", "123",200);
        Speaker speaker = new Speaker("s", "s", "789",300);
        assertEquals("incorrect userID\n", 100, attendee.getUserId());
        assertEquals("incorrect userID\n", 200, organizer.getUserId());
        assertEquals("incorrect userID\n", 300, speaker.getUserId());
    }
    ...
    public void testGetPassword(){
        Attendee attendee = new Attendee("a", "a", "123",100);
        Organizer organizer = new Organizer("o", "o", "456",200);
        Speaker speaker = new Speaker("s", "s", "789",300);
    ...
    public void testGetMessages(){
        ...
        Message message1 = new Message(1, 2, "Hi",111);
        ...
        Message message2 = new Message(1, 3, "Hello",112);
