...
public class AttendeeManagerTest {
    ...
    public void tests(){
        ...
        Attendee a1 = new Attendee("Steve", "Steve@gmail.com", "123");
        Attendee a2 = new Attendee("Mike", "Mike@gmail.com", "12334");
        Attendee a3 = new Attendee("Crystal", "crystal@gmail.com", "23423");
